    ...
    <form id="form1" runat="server">
        <div class="register-container">
            ...
            <asp:DropDownList ID="DropDownListRole" runat="server">
                ...
                <asp:ListItem Text="User" Value="Farmer" />
            </asp:DropDownList>
            ...
            <asp:Label ID="SucessMessageLabel" runat="server" ForeColor="var(--success-color)"></asp:Label>
            <asp:Label ID="ErrorMessageLabel" runat="server" ForeColor="var(--error-color)"></asp:Label>
